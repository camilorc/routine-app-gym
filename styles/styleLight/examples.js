/**
 * Ejemplos de uso de los estilos centralizados - Tema Claro
...
export const IconButtonExample = () => {
  return (
    ...
    >
      <Ionicons name="add" size={iconStyles.sizes.sm} color="#FFFFFF" />
      <Text
        className={combineStyles(
...
// Ejemplo 9: Badges en tema claro
export const BadgesExample = () => {
  return (
    <View className="flex-row gap-2 flex-wrap">
      <View className={badgeStyles.success}>
        <Text className="text-green-700 text-xs font-semibold">Completado</Text>
      </View>
      <View className={badgeStyles.error}>
        <Text className="text-red-700 text-xs font-semibold">Error</Text>
      </View>
      <View className={badgeStyles.warning}>
        <Text className="text-yellow-700 text-xs font-semibold">Pendiente</Text>
      </View>
      <View className={badgeStyles.info}>
        <Text className="text-blue-700 text-xs font-semibold">Info</Text>
      </View>
      <View className={badgeStyles.neutral}>
        <Text className="text-gray-700 text-xs font-semibold">Neutral</Text>
      </View>
    </View>
  );
};

// Ejemplo 10: Header con tema claro
export const HeaderExample = () => {
  return (
    <View className={containerStyles.header}>
      <TouchableOpacity className="mr-4">
        <Ionicons name="arrow-back" size={24} color={colors.text.primary} />
      </TouchableOpacity>
      <Text className={textStyles.h3}>Mi Perfil</Text>
    </View>
  );
};
